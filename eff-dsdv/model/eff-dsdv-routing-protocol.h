...
#ifndef EFFDSDV_ROUTING_PROTOCOL_H
#define EFFDSDV_ROUTING_PROTOCOL_H

#include "eff-dsdv-rtable.h"
#include "eff-dsdv-packet-queue.h"
...
public:
  static TypeId
  GetTypeId (void);
  static const uint32_t EFFDSDV_PORT;
...
#endif /* EFFDSDV_ROUTING_PROTOCOL_H */
