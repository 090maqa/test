...
class EffDsdvHeader : public Header
{
public:
  EffDsdvHeader (Ipv4Address dst = Ipv4Address (), uint32_t hopcount = 0, uint32_t dstSeqNo = 0);
  virtual ~EffDsdvHeader ();
...
static inline std::ostream & operator<< (std::ostream& os, const EffDsdvHeader & packet)
{
  packet.Print (os);
  return os;
}
